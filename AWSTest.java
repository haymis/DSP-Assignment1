...
//
//        // Path to url file.
//        inputFile = "C:\\Users\\Haymi\\Documents\\BGU\\DSP\\tweetLinks.txt";
//        // Path to final HTML output file.
//        outputFile = "C:\\Users\\Haymi\\Documents\\BGU\\DSP\\tweetLinks.html";;
//        // Worker Ratio
//        n = 4;
//
//
...
//        cleanUp();
    ...
    private static List<String> createGroupsHTMLs() throws IOException {
        ...
        List<String> groupHTMLFiles = new ArrayList<String>();
    ...
    private static String getBootStrapScript(String bootStrap) throws IOException
    {
        ...
        br.close();
        str = new String(Base64.encodeBase64(join(lines, "\n").getBytes()));
        return str;
    }
